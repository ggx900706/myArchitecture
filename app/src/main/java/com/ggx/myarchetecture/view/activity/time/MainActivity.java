...
import com.ggx.myarchetecture.base.view.BaseActivity;
...
public class MainActivity extends BaseActivity<ActivityMainBinding, TimeModule> {
    ...
    protected void onResume() {
        super.onResume();
        Application.changeURL(URL_DOUBAN);
    }
